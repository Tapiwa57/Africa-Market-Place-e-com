...
const menClothesData = [
  { id: 1, image: "/images/men1.jpg", title: "Formal Shirt", ageGroup: "Adults", country: "Zimbabwe", company: "Fashion Co", color: "White", size: "M", price: 60 },
  { id: 2, image: "/images/men2.jpg", title: "Casual Hoodie", ageGroup: "Teenage", country: "Egypt", company: "Trendy Teens", color: "Blue", size: "L", price: 40 },
  { id: 3, image: "/images/men3.jpg", title: "Kids T-Shirt", ageGroup: "Kids", country: "Ghana", company: "Jet", color: "Green", size: "S", price: 20 },
  { id: 4, image: "/images/men4.jpg", title: "Evening Jacket", ageGroup: "Adults", country: "Zimbabwe", company: "Fashion Co", color: "Black", size: "L", price: 120 },
  { id: 5, image: "/images/men5.jpg", title: "Casual Pants", ageGroup: "Teenage", country: "Zimbabwe", company: "Trendy Teens", color: "Gray", size: "M", price: 35 },
  { id: 6, image: "/images/men6.jpg", title: "Kids Shorts", ageGroup: "Kids", country: "Egypt", company: "Jet", color: "Yellow", size: "XS", price: 25 },
];
...
export default function MenClothes() {
  ...
  const filteredClothes = menClothesData.filter((item) =>
