...
export default function Home() {
  const testimonials = [
    { name: "Takudzwa Mudzimwa", country: "Zimbabwean", image: "/takudzwa.jpg" },
    { name: "Roshly Kamble", country: "Egypt", image: "/roshly.jpg" },
    { name: "Daniel M.", country: "Nigeria", image: "/daniel.jpg" },
  ];
      ...
      <section className="bg-black text-white py-12 px-4 md:px-16">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-gray-900 rounded-lg p-6 shadow hover:shadow-lg transition">
              {/* Stars */}
